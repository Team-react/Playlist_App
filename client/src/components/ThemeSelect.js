...
handleGeneratorMount(){
  ...
  render() {
    return (
      ...
      <div>
      <form>
      <input id='input' type="text" className="form-group w-25" name="playlist_type" 
      ...
      <form>
      <input type="text" className="form-group w-25"
             name="duration"
    ...
    <button type="button" className="btn btn-success" disabled={!this.state.desiredDuration || !this.state.playlist_type } onClick={this.mountGeneratorHandler}>
    I'm Ready!
    </button>
    </div>
